			  ...
			  uint32_t size)
{
	...
	args->list[curr_idx].type = VACCEL_ARG_RAW;
	args->list[curr_idx].custom_type_id = 0;
			     ...
			     void *(*serializer)(void *, uint32_t *))
{
	...
	args->list[curr_idx].type = VACCEL_ARG_CUSTOM;
	args->list[curr_idx].custom_type_id = type;
