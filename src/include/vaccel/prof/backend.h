...
struct vaccel_prof_backend {
	...
	int (*region_stop)(struct vaccel_prof_region *region);
	int (*region_stop_with_context)(struct vaccel_prof_region *region,
	...
	int (*region_print)(struct vaccel_prof_region *region);
